...
# Examples:
#
#   # Amz::Base includes Preferable and defines preferences as a serialized
#   # column.
#   class Settings < Amz::Base
...
#   s.save!
module Amz::Preferences::Preferable
    extend ActiveSupport::Concern
  
    included do
      extend Amz::Preferences::PreferableClassMethods
    end
